...
class TrainArgs(BaseArgs):
  ...
  def __init__(self):
    ...
    self.parser.add_argument('--swap_lin_loss', type=int, default=50, help='When to swap the linearity loss')
    self.parser.add_argument('--alternating_loss', type=bool, default=False, help='Whether we alternate between linear losses')
